...
router.post('/update', function(req, res, next) {
	...
	req.db.none('update lending set status=$1 where item_id = $2 and borrower_id = $3 and abs(request_timestamp - $4) < 0.1', [req.body.status, req.body.item_id, req.body.borrower_id, req.body.request_timestamp])
		.then(function () {	
			res.status(200)
				.json({
					status: true,
